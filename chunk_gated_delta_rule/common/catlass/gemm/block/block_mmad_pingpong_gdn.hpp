...
#ifndef CATLASS_GEMM_BLOCK_BLOCK_MMAD_PINGPONG_GDN_HPP
#define CATLASS_GEMM_BLOCK_BLOCK_MMAD_PINGPONG_GDN_HPP
...
>
struct BlockMmad <
    MmadAtlasA2PingpongGdn<ENABLE_UNIT_FLAG_>,
    L1TileShape_,
    L0TileShape_,
    AType_,
    BType_,
...
public:
    // Type Aliases
    using DispatchPolicy = MmadAtlasA2PingpongGdn<ENABLE_UNIT_FLAG_>;
    ...
    void preSetFlags()
    {
        ...
        for (uint32_t i = 0; i < STAGES; i++) {
            // The event id that needs to be set before the layoutOutput
...
#endif // CATLASS_GEMM_BLOCK_BLOCK_MMAD_PINGPONG_GDN_HPP
