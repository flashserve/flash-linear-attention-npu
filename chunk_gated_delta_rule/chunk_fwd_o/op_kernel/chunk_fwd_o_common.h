...
/*!
 * \file chunk_fwd_o_common.h
 * \brief Shared constants, helpers, and schedulers for chunk_fwd_o
 */

#ifndef CHUNK_FWD_O_COMMON_H
#define CHUNK_FWD_O_COMMON_H
...
struct BlockSchedulerGdnFwdO {
    ...
    Catlass::Arch::CrossCoreFlag cube1Done{3};
    Catlass::Arch::CrossCoreFlag vec1Done{4};
    Catlass::Arch::CrossCoreFlag cube2Done{5};
    Catlass::Arch::CrossCoreFlag cube3Done{6};
    Catlass::Arch::CrossCoreFlag vec2Done{7};
