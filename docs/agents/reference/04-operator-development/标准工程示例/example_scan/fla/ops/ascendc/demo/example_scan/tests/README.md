<!--
示例文件：fla/ops/ascendc/demo/example_scan/tests/README.md
...
| 文件 | 用途 | 是否长期保留 |
| --- | --- | --- |
| `gen_scan_cases.py`（示例，按需新建） | 开发期输入生成/对齐，正式用例由 `tests/atk/example_scan/gen_example_scan.py` 负责 | 否 |

正式看护见 [`../../../../../../tests/atk/example_scan/README.md`](../../../../../../tests/atk/example_scan/README.md)。
