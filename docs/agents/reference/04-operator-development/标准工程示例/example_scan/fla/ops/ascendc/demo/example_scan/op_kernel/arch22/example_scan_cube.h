/**
 * 示例文件：.../op_kernel/arch22/example_scan_cube.h
 *
 * 注意事项：
 ...
 *   4. L1/L0 的申请份数必须与 host 侧 arch22/example_scan_tiling_impl.h 的常量一致；
 *      改一处必须同步另一处。
 *   5. 这里不做运行期平台判断：本文件只在非 A5 编译时被 include。
 */

#ifndef EXAMPLE_SCAN_CUBE_ARCH22_H
#define EXAMPLE_SCAN_CUBE_ARCH22_H

template <typename XT, typename GT, typename Policy>
class ExampleScanCube {
public:
    __aicore__ inline void Init(const ExampleScanArgs &args) { args_ = &args; }
...
#endif // EXAMPLE_SCAN_CUBE_ARCH22_H
