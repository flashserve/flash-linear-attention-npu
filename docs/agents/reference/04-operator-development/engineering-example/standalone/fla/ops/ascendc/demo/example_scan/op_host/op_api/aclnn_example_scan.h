/**
 * 示例文件：fla/ops/ascendc/demo/example_scan/op_host/op_api/aclnn_example_scan.h
 *
 * 注意事项：
...
#ifndef OP_API_INC_ACLNN_EXAMPLE_SCAN_H
#define OP_API_INC_ACLNN_EXAMPLE_SCAN_H
...
#endif // OP_API_INC_ACLNN_EXAMPLE_SCAN_H
