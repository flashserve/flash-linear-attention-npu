/**
 * 示例文件：.../op_name_fused/op_host/op_api/aclnn_op_name_fused.h
 *
 * 注意事项：
...
#ifndef OP_API_INC_ACLNN_OP_NAME_FUSED_H
#define OP_API_INC_ACLNN_OP_NAME_FUSED_H
...
/* OpNameFused：在同一 executor 内组合 OpName 与 OpNameTail。
 *
 ...
 */
ACLNN_API aclnnStatus aclnnOpNameFusedGetWorkspaceSize(
    const aclTensor *x,
    const aclTensor *g,
...
ACLNN_API aclnnStatus aclnnOpNameFused(void *workspace, uint64_t workspaceSize,
...
#endif // OP_API_INC_ACLNN_OP_NAME_FUSED_H
