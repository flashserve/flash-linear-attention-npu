/**
 * 示例文件：fla/ops/ascendc/gdn/op_name/op_host/arch22/op_name_tiling_impl.h
 *
 * 注意事项：
...
#ifndef OP_NAME_TILING_IMPL_ARCH22_H
#define OP_NAME_TILING_IMPL_ARCH22_H
...
constexpr uint32_t OP_NAME_ARCH22_TILE_T = 32;
constexpr uint32_t OP_NAME_ARCH22_TILE_D = 128;
constexpr uint32_t OP_NAME_ARCH22_UB_SLOT_COUNT = 2;
constexpr uint32_t OP_NAME_ARCH22_L1_SLOT_COUNT = 2;
constexpr uint64_t OP_NAME_ARCH22_STATE_SLOT_BYTES = 0;  // 按实际 head 数计算

inline constexpr bool IsArch22Supported(uint32_t socArch) { return socArch != 0; }

} // namespace optiling

#endif // OP_NAME_TILING_IMPL_ARCH22_H
