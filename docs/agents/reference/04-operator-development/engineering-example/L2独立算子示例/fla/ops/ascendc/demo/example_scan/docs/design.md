...
<!--
示例文件：fla/ops/ascendc/demo/example_scan/docs/design.md
...
| --- | --- | --- |
| A2/A3（`arch22`） | `HEAD_PER_CORE` 与 tile 取 `..._ARCH22_*` 常量 | `op_kernel/arch22/example_scan_{cube,vec}.h` |
| A5（`arch35`） | tile 更大、`LibApiWorkSpaceSize` 计入 workspace | `op_kernel/arch35/example_scan_{cube,vec}.h` |
