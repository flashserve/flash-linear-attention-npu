...
- 修改 `fla_npu` Python runtime、wheel 打包、OPP 安装、依赖版本门禁、legacy `torch.ops.npu` 兼容路径、stream 或 autograd 绑定前，先读 [`torch-npu-decoupled-architecture.md`](torch-npu-decoupled-architecture.md)。
