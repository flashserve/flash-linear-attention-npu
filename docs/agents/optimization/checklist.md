...
本清单用于性能设计和实现交付。通用工程交付同时执行 [`../development/checklist.md`](../development/checklist.md)。
...
- [ ] 实现结构符合 [`../development/coding-standard.md`](../development/coding-standard.md)，A5 路径同时符合 [`soc/a5.md`](soc/a5.md) 的编码规范。
