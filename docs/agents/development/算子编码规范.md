...
交付时同时执行 [`算子开发交付清单.md`](算子开发交付清单.md)。性能优化还要执行 [`../optimization/算子优化检查清单.md`](../optimization/算子优化检查清单.md)，A5 实现额外执行 [`../optimization/soc/A5优化约束.md`](../optimization/soc/A5优化约束.md) 的编码与架构检查。
