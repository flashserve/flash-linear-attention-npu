...
首次参与本仓开发时先读 [`../基础知识.md`](../基础知识.md)。任何算子开发、优化或检视开始前先执行 [`算子开发通用约束.md`](算子开发通用约束.md)，编写或重构 Ascend C 代码前再阅读 [`算子编码规范.md`](算子编码规范.md)。涉及性能设计、stage、resident、head window、流水或 SOC 优化时，按 [`../optimization/README.md`](../optimization/README.md) 加载对应分类文档。
