...
首次参与本仓开发时先读 [`../基础知识.md`](../基础知识.md)。开始编写或重构代码前阅读 [`算子编码规范.md`](算子编码规范.md)。涉及性能设计、stage、resident、head window、流水或 SOC 优化时，按 [`../optimization/README.md`](../optimization/README.md) 加载对应分类文档。
