...
usage() {
    ...
    echo "  chunk_local_cumsum, chunk_scaled_dot_kkt, chunk_kda_fwd_finalize"
    exit 1
}
...
run_test "chunk_kda_fwd_finalize"          "timeout --signal=TERM --kill-after=5s 60s python3 test_npu_chunk_kda_fwd_finalize.py"
