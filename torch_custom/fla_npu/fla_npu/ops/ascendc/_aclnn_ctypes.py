...
def npu_recurrent_gated_delta_rule(
    ...
    *,
    ...
    # RecurrentGatedDeltaRule only registers ND tensors. Standard contiguous
    # rank-3/rank-4 NPU tensors may carry NCL/NCHW tags even though their
    # storage is row-major. Describe this operator's dense inputs and output
    # as ND without introducing an NPU-side format conversion or data copy.
