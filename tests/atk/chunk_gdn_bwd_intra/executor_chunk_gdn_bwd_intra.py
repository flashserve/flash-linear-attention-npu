"""chunk_gdn_bwd_intra 的 ATK executor。"""
...
def _compute_intermediates(inputs: dict[str, Any]):
...
def _cpu_ref(inputs: dict[str, Any]):
    ...
    a_bg_all, a_beta_all, d_all = _compute_intermediates(inputs)
