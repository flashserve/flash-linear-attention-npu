...
from executor_chunk_gdn_bwd_intra import _cpu_ref, build_inputs
...
def main() -> None:
    ...
    refs = _cpu_ref(cpu_inputs)
    for index, (output, ref) in enumerate(zip(outputs, refs)):
