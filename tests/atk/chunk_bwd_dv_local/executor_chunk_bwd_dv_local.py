...
def _chunk_bwd_dv_local_ref(inputs):
...
def run_npu(spec: dict[str, Any], input_data: InputDataset):
    ...
    return ascendc.chunk_bwd_dv_local(inputs["q"], inputs["k"], inputs["do"], inputs["g"], inputs["scale"], inputs["chunk_size"], g_gamma=None, A=None, cu_seqlens=None, chunk_indices=None)
