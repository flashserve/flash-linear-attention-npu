...
- `use_exp2=True`、`use_gate_in_kernel=False` 固定。
- `use_qk_l2norm_in_kernel`、`use_beta_sigmoid_in_kernel`、`allow_neg_eigval` 支持 True/False；`allow_neg_eigval=True` 要求 sigmoid。精度 JSON 覆盖全部 6 组合法组合。
