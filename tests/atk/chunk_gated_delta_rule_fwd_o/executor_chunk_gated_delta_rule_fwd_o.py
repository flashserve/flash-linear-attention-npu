"""chunk_gated_delta_rule_fwd_o 的 ATK executor。
...
OP_NAME = "chunk_gated_delta_rule_fwd_o"
...
def _chunk_gated_delta_rule_fwd_o_ref(inputs):
...
def run_cpu(spec: dict[str, Any], high_precision: bool = False):
    ...
    return _chunk_gated_delta_rule_fwd_o_ref(inputs)
...
def run_npu(spec: dict[str, Any], input_data: InputDataset):
    ...
    return ascendc.chunk_gated_delta_rule_fwd_o(
...
@register("executor_chunk_gated_delta_rule_fwd_o")
