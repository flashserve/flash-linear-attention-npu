#!/usr/bin/env python3
"""Profile JSON performance cases for solve_tri with msopprof."""
...
def main():
    ...
    parser.add_argument("--output", default="outputs/solve_tri_msopprof")
    ...
    env = os.environ.copy()
    env.update({
        "FLA_NPU_OPERATOR": "solve_tri",
        "FLA_NPU_CASE_MANIFEST": str(ROOT / "tests/op_cases/solve_tri.json"),
