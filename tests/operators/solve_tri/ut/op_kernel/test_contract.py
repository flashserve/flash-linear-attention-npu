"""Static kernel/tiling contract for solve_tri."""

from pathlib import Path


ROOT = Path(__file__).resolve().parents[5]
OP_ROOT = ROOT / "fla/ops/ascendc/gdn/chunk_gdn_fwd/solve_tri"


def test_direct_launch_matches_a_real_kernel_entry():
    direct = ROOT / "tests/operators/solve_tri/routes/test_direct_solve_tri.cpp"
