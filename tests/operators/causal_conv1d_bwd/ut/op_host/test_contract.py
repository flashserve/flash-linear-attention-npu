"""Static op_host contract for causal_conv1d_bwd; device execution lives in accuracy/routes."""

from tests.operators.causal_conv1d_bwd.common.case_matrix import manifest
