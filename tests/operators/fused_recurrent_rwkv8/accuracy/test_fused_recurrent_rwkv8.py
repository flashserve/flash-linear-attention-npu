"""Canonical JSON entry for FusedRecurrentRwkv8 accuracy/generalization tests."""
...
RUNNER = ROOT / "tests/operators/_shared/fused_recurrent_rwkv8_backend.py"
...
def test_case_manifest_covers_required_matrix():
    ...
    assert {"ascend910b"} <= set(manifest["capability"]["soc"])
