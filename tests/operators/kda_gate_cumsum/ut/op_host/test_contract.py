"""Static op_host contract for kda_gate_cumsum; device execution lives in accuracy/routes."""

from tests.operators.kda_gate_cumsum.common.case_matrix import manifest
