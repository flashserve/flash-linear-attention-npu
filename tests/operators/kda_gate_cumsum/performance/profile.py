#!/usr/bin/env python3
"""Profile JSON performance cases for kda_gate_cumsum with msopprof."""
...
def main():
    ...
    parser.add_argument("--output", default="outputs/kda_gate_cumsum_msopprof")
    ...
    env = os.environ.copy()
    env.update({
        "FLA_NPU_OPERATOR": "kda_gate_cumsum",
        "FLA_NPU_CASE_MANIFEST": str(ROOT / "tests/op_cases/kda_gate_cumsum.json"),
