...
_COMMON_DIR = os.path.join(os.path.dirname(_SCRIPT_DIR), "common")
sys.path.insert(0, _COMMON_DIR)
import legacy_golden as _golden_mod
...
CASES = [
    BwdDhuCase(**case["legacy"]["raw"])
    for case in load_legacy_cases("chunk_gated_delta_rule_bwd_dhu", "gva_dual")
]
