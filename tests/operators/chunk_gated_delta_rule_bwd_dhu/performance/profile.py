#!/usr/bin/env python3
"""Profile JSON performance cases for chunk_gated_delta_rule_bwd_dhu with msopprof."""
...
def main():
    ...
    parser.add_argument("--output", default="outputs/chunk_gated_delta_rule_bwd_dhu_msopprof")
    ...
    env = os.environ.copy()
    env.update({
        "FLA_NPU_OPERATOR": "chunk_gated_delta_rule_bwd_dhu",
        "FLA_NPU_CASE_MANIFEST": str(ROOT / "tests/op_cases/chunk_gated_delta_rule_bwd_dhu.json"),
