"""Static op_host contract for chunk_gated_delta_rule_bwd_dhu; device execution lives in accuracy/routes."""

from tests.operators.chunk_gated_delta_rule_bwd_dhu.common.case_matrix import manifest
