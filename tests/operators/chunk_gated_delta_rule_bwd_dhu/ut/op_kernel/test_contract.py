"""Static kernel/tiling contract for chunk_gated_delta_rule_bwd_dhu."""

from pathlib import Path


ROOT = Path(__file__).resolve().parents[5]
OP_ROOT = ROOT / "fla/ops/ascendc/gdn/chunk_gdn_bwd/chunk_gated_delta_rule_bwd_dhu"


def test_direct_launch_matches_a_real_kernel_entry():
    direct = ROOT / "tests/operators/chunk_gated_delta_rule_bwd_dhu/routes/test_direct_chunk_gated_delta_rule_bwd_dhu.cpp"
