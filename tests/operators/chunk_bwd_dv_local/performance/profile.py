#!/usr/bin/env python3
"""Profile JSON performance cases for chunk_bwd_dv_local with msopprof."""
...
def main():
    ...
    parser.add_argument("--output", default="outputs/chunk_bwd_dv_local_msopprof")
    ...
    env = os.environ.copy()
    env.update({
        "FLA_NPU_OPERATOR": "chunk_bwd_dv_local",
        "FLA_NPU_CASE_MANIFEST": str(ROOT / "tests/op_cases/chunk_bwd_dv_local.json"),
