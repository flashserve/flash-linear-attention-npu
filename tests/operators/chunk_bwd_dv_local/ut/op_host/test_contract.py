"""Static op_host contract for chunk_bwd_dv_local; device execution lives in accuracy/routes."""

from tests.operators.chunk_bwd_dv_local.common.case_matrix import manifest
