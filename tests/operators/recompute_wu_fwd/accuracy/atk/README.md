# recompute_wu_fwd ATK 回归资产

## 用例来源

唯一用例来源是 tests/op_cases/recompute_wu_fwd.json 中 legacy.suite=atk_legacy_mislabeled 的 2 条记录。
...
## 物化与执行
    ...
    python3 -m tests.operators._shared.legacy_cases materialize \
      ...
      --output /tmp/recompute_wu_fwd_atk.json
