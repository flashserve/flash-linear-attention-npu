"""Static kernel/tiling contract for recompute_wu_fwd."""

from pathlib import Path


ROOT = Path(__file__).resolve().parents[5]
OP_ROOT = ROOT / "fla/ops/ascendc/gdn/chunk_gdn_fwd/recompute_wu_fwd"


def test_direct_launch_matches_a_real_kernel_entry():
    direct = ROOT / "tests/operators/recompute_wu_fwd/routes/test_direct_recompute_wu_fwd.cpp"
