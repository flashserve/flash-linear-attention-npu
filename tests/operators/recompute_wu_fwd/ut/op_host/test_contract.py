"""Static op_host contract for recompute_wu_fwd; device execution lives in accuracy/routes."""

from tests.operators.recompute_wu_fwd.common.case_matrix import manifest
