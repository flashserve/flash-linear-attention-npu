#!/usr/bin/env python3
"""Profile JSON performance cases for prepare_wy_repr_bwd_da with msopprof."""
...
RUNNER = ROOT / "tests/operators/prepare_wy_repr_bwd_da/accuracy/backend.py"


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument("--dry-run", action="store_true")
    parser.add_argument("--output", default="outputs/prepare_wy_repr_bwd_da_msopprof")
