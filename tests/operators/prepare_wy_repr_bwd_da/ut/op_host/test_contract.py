"""Static op_host contract for prepare_wy_repr_bwd_da; device execution lives in accuracy/routes."""

from tests.operators.prepare_wy_repr_bwd_da.common.case_matrix import manifest
