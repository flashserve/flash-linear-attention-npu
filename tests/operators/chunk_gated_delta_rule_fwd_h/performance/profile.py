#!/usr/bin/env python3
"""Profile JSON performance cases for chunk_gated_delta_rule_fwd_h with msopprof."""
...
def main():
    ...
    parser.add_argument("--output", default="outputs/chunk_gated_delta_rule_fwd_h_msopprof")
