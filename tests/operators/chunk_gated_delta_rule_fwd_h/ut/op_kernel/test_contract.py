"""Static kernel/tiling contract for chunk_gated_delta_rule_fwd_h."""

from pathlib import Path


ROOT = Path(__file__).resolve().parents[5]
OP_ROOT = ROOT / "fla/ops/ascendc/gdn/chunk_gdn_fwd/chunk_gated_delta_rule_fwd_h"


def test_direct_launch_matches_a_real_kernel_entry():
    direct = ROOT / "tests/operators/chunk_gated_delta_rule_fwd_h/routes/test_direct_chunk_gated_delta_rule_fwd_h.cpp"
