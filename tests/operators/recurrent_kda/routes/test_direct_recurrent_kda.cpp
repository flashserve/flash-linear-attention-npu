...
extern "C" __global__ __aicore__ void recurrent_kda(
    ...
    GM_ADDR out, GM_ADDR initialStateOut, GM_ADDR finalState, GM_ADDR workspace, GM_ADDR tiling);
                        ...
                        GM_ADDR tiling)
{
    recurrent_kda<<<blockDim, nullptr, stream>>>(query, key, value, gate, beta, initialState, cuSeqlens,
                                                 ...
                                                 initialStateOut, finalState, workspace, tiling);
}
