"""Static kernel/tiling contract for recurrent_gated_delta_rule."""

from pathlib import Path


ROOT = Path(__file__).resolve().parents[5]
OP_ROOT = ROOT / "fla/ops/ascendc/gdn/recurrent_gdn/recurrent_gated_delta_rule"


def test_direct_launch_matches_a_real_kernel_entry():
    direct = ROOT / "tests/operators/recurrent_gated_delta_rule/routes/test_direct_recurrent_gated_delta_rule.cpp"
