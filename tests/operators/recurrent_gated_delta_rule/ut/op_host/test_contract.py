"""Static op_host contract for recurrent_gated_delta_rule; device execution lives in accuracy/routes."""

from tests.operators.recurrent_gated_delta_rule.common.case_matrix import manifest
