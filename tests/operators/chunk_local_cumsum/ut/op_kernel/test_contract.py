"""Static kernel/tiling contract for chunk_local_cumsum."""

from pathlib import Path


ROOT = Path(__file__).resolve().parents[5]
OP_ROOT = ROOT / "fla/ops/ascendc/gdn/gdn_preprocess/chunk_local_cumsum"


def test_direct_launch_matches_a_real_kernel_entry():
    direct = ROOT / "tests/operators/chunk_local_cumsum/routes/test_direct_chunk_local_cumsum.cpp"
