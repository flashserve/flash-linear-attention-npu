"""Static op_host contract for causal_conv1d; device execution lives in accuracy/routes."""

from tests.operators.causal_conv1d.common.case_matrix import manifest
