"""Static kernel/tiling contract for causal_conv1d."""

from pathlib import Path


ROOT = Path(__file__).resolve().parents[5]
OP_ROOT = ROOT / "fla/ops/ascendc/gdn/gdn_preprocess/causal_conv1d"


def test_direct_launch_matches_a_real_kernel_entry():
    direct = ROOT / "tests/operators/causal_conv1d/routes/test_direct_causal_conv1d.cpp"
