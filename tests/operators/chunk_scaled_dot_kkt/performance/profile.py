#!/usr/bin/env python3
"""Profile JSON performance cases for chunk_scaled_dot_kkt with msopprof."""
...
def main():
    ...
    parser.add_argument("--output", default="outputs/chunk_scaled_dot_kkt_msopprof")
    ...
    env = os.environ.copy()
    env.update({
        "FLA_NPU_OPERATOR": "chunk_scaled_dot_kkt",
        "FLA_NPU_CASE_MANIFEST": str(ROOT / "tests/op_cases/chunk_scaled_dot_kkt.json"),
