"""Static op_host contract for chunk_scaled_dot_kkt; device execution lives in accuracy/routes."""

from tests.operators.chunk_scaled_dot_kkt.common.case_matrix import manifest
