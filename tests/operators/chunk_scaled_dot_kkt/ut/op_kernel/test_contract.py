"""Static kernel/tiling contract for chunk_scaled_dot_kkt."""

from pathlib import Path


ROOT = Path(__file__).resolve().parents[5]
OP_ROOT = ROOT / "fla/ops/ascendc/gdn/gdn_preprocess/chunk_scaled_dot_kkt"


def test_direct_launch_matches_a_real_kernel_entry():
    direct = ROOT / "tests/operators/chunk_scaled_dot_kkt/routes/test_direct_chunk_scaled_dot_kkt.cpp"
