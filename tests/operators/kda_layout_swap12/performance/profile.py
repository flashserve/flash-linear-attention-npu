#!/usr/bin/env python3
"""Profile JSON performance cases for kda_layout_swap12 with msopprof."""
...
from tests.operators.kda_layout_swap12.common.case_matrix import case_ids
...
def main():
    ...
    parser.add_argument("--output", default="outputs/kda_layout_swap12_msopprof")
    ...
    env = os.environ.copy()
    env.update({
        "FLA_NPU_OPERATOR": "kda_layout_swap12",
        "FLA_NPU_CASE_MANIFEST": str(ROOT / "tests/op_cases/kda_layout_swap12.json"),
