"""Static op_host contract for kda_layout_swap12; device execution lives in accuracy/routes."""

from tests.operators.kda_layout_swap12.common.case_matrix import manifest
