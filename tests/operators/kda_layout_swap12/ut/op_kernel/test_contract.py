"""Static kernel/tiling contract for kda_layout_swap12."""

from pathlib import Path


ROOT = Path(__file__).resolve().parents[5]
OP_ROOT = ROOT / "fla/ops/ascendc/kda/kda_layout_swap12"


def test_direct_launch_matches_a_real_kernel_entry():
    direct = ROOT / "tests/operators/kda_layout_swap12/routes/test_direct_kda_layout_swap12.cpp"
