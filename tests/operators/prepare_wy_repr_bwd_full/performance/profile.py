#!/usr/bin/env python3
"""Profile JSON performance cases for prepare_wy_repr_bwd_full with msopprof."""
...
RUNNER = ROOT / "torch_custom/fla_npu/test/test_npu_prepare_wy_repr_bwd_full.py"


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument("--dry-run", action="store_true")
    parser.add_argument("--output", default="outputs/prepare_wy_repr_bwd_full_msopprof")
    ...
    env = os.environ.copy()
    env.update({
        "FLA_NPU_OPERATOR": "prepare_wy_repr_bwd_full",
        "FLA_NPU_CASE_MANIFEST": str(ROOT / "tests/op_cases/prepare_wy_repr_bwd_full.json"),
