"""Static op_host contract for prepare_wy_repr_bwd_full; device execution lives in accuracy/routes."""

from tests.operators.prepare_wy_repr_bwd_full.common.case_matrix import manifest
