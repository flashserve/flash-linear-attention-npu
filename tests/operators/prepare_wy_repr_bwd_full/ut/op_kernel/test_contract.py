"""Static kernel/tiling contract for prepare_wy_repr_bwd_full."""

from pathlib import Path


ROOT = Path(__file__).resolve().parents[5]
OP_ROOT = ROOT / "fla/ops/ascendc/gdn/chunk_gdn_bwd/prepare_wy_repr_bwd_full"


def test_direct_launch_matches_a_real_kernel_entry():
    direct = ROOT / "tests/operators/prepare_wy_repr_bwd_full/routes/test_direct_prepare_wy_repr_bwd_full.cpp"
