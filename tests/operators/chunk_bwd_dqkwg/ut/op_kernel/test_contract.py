"""Static kernel/tiling contract for chunk_bwd_dqkwg."""

from pathlib import Path


ROOT = Path(__file__).resolve().parents[5]
OP_ROOT = ROOT / "fla/ops/ascendc/gdn/chunk_gdn_bwd/chunk_bwd_dqkwg"


def test_direct_launch_matches_a_real_kernel_entry():
    direct = ROOT / "tests/operators/chunk_bwd_dqkwg/routes/test_direct_chunk_bwd_dqkwg.cpp"
