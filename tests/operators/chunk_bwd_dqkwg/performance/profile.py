#!/usr/bin/env python3
"""Profile JSON performance cases for chunk_bwd_dqkwg with msopprof."""
...
RUNNER = ROOT / "torch_custom/fla_npu/test/test_npu_chunk_bwd_dqkwg.py"


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument("--dry-run", action="store_true")
    parser.add_argument("--output", default="outputs/chunk_bwd_dqkwg_msopprof")
    ...
    env = os.environ.copy()
    env.update({
        "FLA_NPU_OPERATOR": "chunk_bwd_dqkwg",
        "FLA_NPU_CASE_MANIFEST": str(ROOT / "tests/op_cases/chunk_bwd_dqkwg.json"),
