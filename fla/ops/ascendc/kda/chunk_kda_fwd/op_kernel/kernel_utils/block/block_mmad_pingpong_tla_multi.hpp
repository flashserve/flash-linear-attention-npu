...
#ifndef FLA_NPU_KDA_BLOCK_MMAD_PINGPONG_TLA_MULTI_HPP
#define FLA_NPU_KDA_BLOCK_MMAD_PINGPONG_TLA_MULTI_HPP
#define FLA_NPU_KERNEL_UTIL_MMAD_MULTI_PROVIDED 1
...
#endif // FLA_NPU_KDA_BLOCK_MMAD_PINGPONG_TLA_MULTI_HPP
