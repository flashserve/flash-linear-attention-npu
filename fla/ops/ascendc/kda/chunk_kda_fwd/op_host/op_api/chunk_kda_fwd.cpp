...
KdaCoreOutputs KdaChunkForward(
    ...
    const aclTensor *stageGkInputOptional,
    const aclTensor *stageAqkInputOptional,
    const aclTensor *stageAkkInputOptional,
    const aclTensor *stageWInputOptional,
    const aclTensor *stageUInputOptional,
    const aclTensor *stageKgInputOptional,
    const aclTensor *stageVNewInputOptional,
    const aclTensor *stageHInputOptional,
    const aclTensor *stageQgScaledInputOptional,
    const aclTensor *stageUSeedInputOptional,
    const aclTensor *stageVNewFp32InputOptional,
    const aclTensor *stageHFp32InputOptional,
    const aclTensor *stageAkkFp32InputOptional,
    const aclTensor *stageWFp32InputOptional,
    double scale,
    int64_t chunkSize,
    bool safeGate,
    ...
    const aclTensor *vNewFp32Out,
    const aclTensor *hFp32Out,
    const aclTensor *akkFp32Out,
    const aclTensor *wFp32Out,
    int64_t stage,
    aclOpExecutor *executor)
{
    L0_DFX(KdaChunkForward, q, k, v, g, beta, aLogOptional, dtBiasOptional,
           ...
           stageGkInputOptional, stageAqkInputOptional, stageAkkInputOptional,
           stageWInputOptional, stageUInputOptional, stageKgInputOptional,
           stageVNewInputOptional, stageHInputOptional,
           ...
           vNewFp32Out, hFp32Out, akkFp32Out, wFp32Out, stage);
    ...
    auto ret = ADD_TO_LAUNCHER_LIST_AICORE(
        ...
        OP_INPUT(q, k, v, g, beta, aLogOptional, dtBiasOptional,
                 ...
                 stageAkkInputOptional, stageWInputOptional,
                 stageUInputOptional, stageKgInputOptional,
                 stageVNewInputOptional, stageHInputOptional,
                 stageQgScaledInputOptional, stageUSeedInputOptional,
                 stageVNewFp32InputOptional, stageHFp32InputOptional,
                 stageAkkFp32InputOptional, stageWFp32InputOptional),
