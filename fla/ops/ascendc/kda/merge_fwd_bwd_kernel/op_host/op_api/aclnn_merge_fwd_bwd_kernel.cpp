    ...
    uint64_t *workspaceSize, aclOpExecutor **executor)
{
    ...
    CHECK_COND(preOrPostNumRanks >= 1, ACLNN_ERR_PARAM_INVALID, "preOrPostNumRanks must be >= 1.");
    ...
    auto outputs = l0op::MergeFwdBwdKernel(agContig, rank, preOrPostNumRanks, forward, hContig, executorPtr);
