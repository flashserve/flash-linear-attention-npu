...
public:
    explicit ChunkKdaFwdPrepare(const char *name) : OpDef(name)
    {
        ...
        this->Output("qg_scaled").ParamType(REQUIRED).DataType(dataTypes).Format(formats).UnknownShapeFormat(formats);
        this->Output("w_seed").ParamType(REQUIRED).DataType(dataTypes).Format(formats).UnknownShapeFormat(formats);
        this->Output("u_seed").ParamType(REQUIRED).DataType(dataTypes).Format(formats).UnknownShapeFormat(formats);
