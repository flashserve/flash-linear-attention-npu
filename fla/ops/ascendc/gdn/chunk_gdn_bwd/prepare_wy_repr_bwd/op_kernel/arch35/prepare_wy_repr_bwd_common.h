 ...
 * \brief Common helpers for fused prepare_wy_repr_bwd A5 kernel.
 */
...
constexpr uint32_t PREPARE_WY_REPR_BWD_CV_BUFFER_COUNT = 2;
constexpr uint64_t PREPARE_WY_REPR_BWD_CV_SUBBLOCK_FLAG_STRIDE = 16;
constexpr uint32_t PREPARE_WY_REPR_BWD_DA6_CV_BUFFER_COUNT = PREPARE_WY_REPR_BWD_CV_BUFFER_COUNT;
constexpr uint64_t PREPARE_WY_REPR_BWD_DA6_CV_AIV_TO_AIC_FLAG_BEGIN = 1;
constexpr uint64_t PREPARE_WY_REPR_BWD_DA6_CV_AIC_TO_AIV_FLAG_BEGIN = 6;
constexpr uint32_t PREPARE_WY_REPR_BWD_DKB_CV_BUFFER_COUNT = PREPARE_WY_REPR_BWD_CV_BUFFER_COUNT;
constexpr uint64_t PREPARE_WY_REPR_BWD_DKB_CV_AIV_TO_AIC_FLAG_BEGIN = 3;
constexpr uint64_t PREPARE_WY_REPR_BWD_DKB_CV_AIC_TO_AIV_FLAG_BEGIN = 8;
constexpr uint32_t PREPARE_WY_REPR_BWD_DK_CV_BUFFER_COUNT = PREPARE_WY_REPR_BWD_CV_BUFFER_COUNT;
constexpr uint64_t PREPARE_WY_REPR_BWD_DK_CV_AIV_TO_AIC_FLAG_BEGIN = 10;
constexpr uint64_t PREPARE_WY_REPR_BWD_DK_CV_AIC_TO_AIV_FLAG_BEGIN = 12;
