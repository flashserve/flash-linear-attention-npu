...
if __name__ == "__main__":
    ...
    # chunk_indices = prepare_chunk_indices(cu_seqlens, chunk_size = 64)
    # test_prepare_wy_repr_bwd_full(B = 1, VH = 32, KH = 16, T = 16384, K = 128, V = 256, chunk_size = 64, ktype=torch.bfloat16, btype=torch.float32, cu_seqlens = cu_seqlens, chunk_indices=chunk_indices)
    # # L8
    ...
    # chunk_indices = prepare_chunk_indices(cu_seqlens, chunk_size = 64)
    # test_prepare_wy_repr_bwd_full(B = 1, VH = 32, KH = 16, T = 65536, K = 128, V = 128, chunk_size = 64, ktype=torch.bfloat16, btype=torch.float32, cu_seqlens = cu_seqlens, chunk_indices=chunk_indices)
    # # L11
    ...
    # chunk_indices = prepare_chunk_indices(cu_seqlens, chunk_size = 64)
    # test_prepare_wy_repr_bwd_full(B = 1, VH = 64, KH = 2, T = 262144, K = 128, V = 256, chunk_size = 64, ktype=torch.bfloat16, btype=torch.float32, cu_seqlens = cu_seqlens, chunk_indices=chunk_indices)
    # # F19
    # test_prepare_wy_repr_bwd_full(B = 1, VH = 32, KH = 16, T = 4096, K = 128, V = 256, chunk_size = 64, ktype=torch.float16, btype=torch.float32)
    # # F20
    # test_prepare_wy_repr_bwd_full(B = 16, VH = 63, KH = 21, T = 2048, K = 128, V = 256, chunk_size = 64, ktype=torch.float16, btype=torch.float32)
    # # F21
    # test_prepare_wy_repr_bwd_full(B = 711, VH = 32, KH = 4, T = 196, K = 128, V = 128, chunk_size = 128, ktype=torch.float16, btype=torch.float32)
    # # F22
    # test_prepare_wy_repr_bwd_full(B = 176, VH = 64, KH = 2, T = 24, K = 128, V = 256, chunk_size = 64, ktype=torch.float16, btype=torch.float32)
