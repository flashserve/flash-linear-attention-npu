...
/*!
 *\file chunk_gated_delta_rule_fwd_o_def.cpp
 *\brief
 */
...
class ChunkGatedDeltaRuleFwdO : public OpDef {

public:
    explicit ChunkGatedDeltaRuleFwdO(const char *name) : OpDef(name)
    {
        // Define inputs
        this->Input("q")
            .ParamType(REQUIRED)
...
OP_ADD(ChunkGatedDeltaRuleFwdO);
