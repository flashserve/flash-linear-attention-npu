...
public:
    ...
    // === l0c2ub / ub2l1 data-path switches (docs/agents/chunk_gated_delta_rule_fwd_o_l0c2ub_ub2l1_design.md) ===
    ...
    __aicore__ inline void Init(GM_ADDR q, GM_ADDR k, GM_ADDR v, GM_ADDR h, GM_ADDR g,
        GM_ADDR cu_seqlens, GM_ADDR chunk_offsets, GM_ADDR o, const GDN::ChunkGatedDeltaRuleFwdOTilingData *tilingData, GM_ADDR user) {
