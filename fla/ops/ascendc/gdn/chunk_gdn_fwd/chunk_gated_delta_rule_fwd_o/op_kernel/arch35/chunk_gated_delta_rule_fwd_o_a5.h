 ...
 *
 * A5 L1<->UB chunk_gated_delta_rule_fwd_o path.
 *
...
#ifndef CHUNK_GATED_DELTA_RULE_FWD_O_ARCH35_A5_H
#define CHUNK_GATED_DELTA_RULE_FWD_O_ARCH35_A5_H

#include "kernel_operator.h"
#include "../chunk_gated_delta_rule_fwd_o_struct.h"
#include "chunk_gated_delta_rule_fwd_o_common.h"
#include "chunk_gated_delta_rule_fwd_o_cube.h"
#include "chunk_gated_delta_rule_fwd_o_vector.h"

namespace GDN {

template <typename GT, bool UseExp2>
class ChunkGatedDeltaRuleFwdOA5 {
public:
    __aicore__ inline void Init(GM_ADDR q, GM_ADDR k, GM_ADDR v, GM_ADDR h, GM_ADDR g, GM_ADDR cuSeqlens,
                                ...
                                const ChunkGatedDeltaRuleFwdOTilingData *tilingData)
    {
        q_ = q;
        k_ = k;
        v_ = v;
    ...
    __aicore__ inline void Process()
    {
        ...
        if ASCEND_IS_AIV {
            AscendC::TPipe pipe;
            ChunkGatedDeltaRuleFwdOA5VectorProcess<GT, UseExp2> vector(q_, k_, v_, h_, g_, cuSeqlens_, chunkOffsets_, o_,
                                                       workspace_);
        ...
        if ASCEND_IS_AIC {
            ChunkGatedDeltaRuleFwdOA5CubeProcess cube(q_, k_, v_, h_, g_, cuSeqlens_, chunkOffsets_, o_, workspace_);
            cube.Init(tiling_);
...
template <typename GT, bool UseExp2>
__aicore__ inline void ChunkGatedDeltaRuleFwdOA5Dispatch(GM_ADDR q, GM_ADDR k, GM_ADDR v, GM_ADDR h, GM_ADDR g,
                                           GM_ADDR cuSeqlens, GM_ADDR chunkOffsets, GM_ADDR o, GM_ADDR workspace,
                                           const ChunkGatedDeltaRuleFwdOTilingData *tilingData)
{
    ChunkGatedDeltaRuleFwdOA5<GT, UseExp2> op;
...
#endif // CHUNK_GATED_DELTA_RULE_FWD_O_ARCH35_A5_H
