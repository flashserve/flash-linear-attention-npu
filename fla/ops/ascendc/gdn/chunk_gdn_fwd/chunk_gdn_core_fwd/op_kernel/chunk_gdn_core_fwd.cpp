    ...
    GM_ADDR finalState, GM_ADDR gCumsumBth, GM_ADDR A, GM_ADDR workspace, GM_ADDR tiling)
{
    ...
    // A is always a full-sized L0 output. When the public ACLNN slot is null,
    // L2 supplies a private output tensor and discards it after this launch.
    GM_ADDR solveA = A;
...
extern "C" __global__ __aicore__ void chunk_gdn_core_fwd(
    GM_ADDR q, GM_ADDR k, GM_ADDR v, GM_ADDR beta, GM_ADDR raw_g,
    ...
    GM_ADDR workspace, GM_ADDR tiling)
{
    ...
    defined(ORIG_DTYPE_INITIAL_STATE) && (ORIG_DTYPE_INITIAL_STATE == DT_FLOAT)
        ...
        KERNEL_TASK_TYPE(61, KERNEL_TYPE_MIX_AIC_1_2);
        GDN::DispatchPhase6ByDtype<Catlass::Gemm::Kernel::GDNFwdHTileShapes128,
                                   GDN::GdnCoreSyncVariant::B6>(
            q, k, v, beta, raw_g, gk, initial_state, cu_seqlens, chunk_indices,
            o, final_state, g_cumsum_bth, A, workspace, tiling);
    } else if (TILING_KEY_IS(71)) {
        KERNEL_TASK_TYPE(71, KERNEL_TYPE_MIX_AIC_1_2);
        GDN::DispatchPhase6ByDtype<Catlass::Gemm::Kernel::GDNFwdHTileShapes128,
                                   GDN::GdnCoreSyncVariant::B7>(
            q, k, v, beta, raw_g, gk, initial_state, cu_seqlens, chunk_indices,
            o, final_state, g_cumsum_bth, A, workspace, tiling);
    } else if (TILING_KEY_IS(81)) {
        KERNEL_TASK_TYPE(81, KERNEL_TYPE_MIX_AIC_1_2);
        GDN::DispatchPhase6ByDtype<Catlass::Gemm::Kernel::GDNFwdHTileShapes128,
                                   GDN::GdnCoreSyncVariant::B8>(
            q, k, v, beta, raw_g, gk, initial_state, cu_seqlens, chunk_indices,
            o, final_state, g_cumsum_bth, A, workspace, tiling);
    } else if (TILING_KEY_IS(91)) {
        KERNEL_TASK_TYPE(91, KERNEL_TYPE_MIX_AIC_1_2);
        GDN::DispatchPhase6ByDtype<Catlass::Gemm::Kernel::GDNFwdHTileShapes128,
                                   GDN::GdnCoreSyncVariant::B9>(
            q, k, v, beta, raw_g, gk, initial_state, cu_seqlens, chunk_indices,
            o, final_state, g_cumsum_bth, A, workspace, tiling);
    } else if (TILING_KEY_IS(101)) {
        KERNEL_TASK_TYPE(101, KERNEL_TYPE_MIX_AIC_1_2);
        GDN::DispatchPhase6ByDtype<Catlass::Gemm::Kernel::GDNFwdHTileShapes128,
                                   GDN::GdnCoreSyncVariant::B10>(
            q, k, v, beta, raw_g, gk, initial_state, cu_seqlens, chunk_indices,
            o, final_state, g_cumsum_bth, A, workspace, tiling);
    } else if (TILING_KEY_IS(111)) {
        KERNEL_TASK_TYPE(111, KERNEL_TYPE_MIX_AIC_1_2);
        GDN::DispatchPhase6ByDtype<Catlass::Gemm::Kernel::GDNFwdHTileShapes128,
                                   GDN::GdnCoreSyncVariant::B11>(
            q, k, v, beta, raw_g, gk, initial_state, cu_seqlens, chunk_indices,
            o, final_state, g_cumsum_bth, A, workspace, tiling);
    } else if (TILING_KEY_IS(121)) {
        KERNEL_TASK_TYPE(121, KERNEL_TYPE_MIX_AIC_1_2);
        GDN::DispatchPhase6ByDtype<Catlass::Gemm::Kernel::GDNFwdHTileShapes128,
                                   GDN::GdnCoreSyncVariant::B12>(
            q, k, v, beta, raw_g, gk, initial_state, cu_seqlens, chunk_indices,
            o, final_state, g_cumsum_bth, A, workspace, tiling);
    } else if (TILING_KEY_IS(131)) {
        KERNEL_TASK_TYPE(131, KERNEL_TYPE_MIX_AIC_1_2);
        GDN::DispatchPhase6ByDtype<Catlass::Gemm::Kernel::GDNFwdHTileShapes128,
                                   GDN::GdnCoreSyncVariant::B13>(
            q, k, v, beta, raw_g, gk, initial_state, cu_seqlens, chunk_indices,
            o, final_state, g_cumsum_bth, A, workspace, tiling);
    } else if (TILING_KEY_IS(141)) {
        KERNEL_TASK_TYPE(141, KERNEL_TYPE_MIX_AIC_1_2);
        GDN::DispatchPhase6ByDtype<Catlass::Gemm::Kernel::GDNFwdHTileShapes128,
                                   GDN::GdnCoreSyncVariant::B14>(
            q, k, v, beta, raw_g, gk, initial_state, cu_seqlens, chunk_indices,
            o, final_state, g_cumsum_bth, A, workspace, tiling);
    } else if (TILING_KEY_IS(151)) {
        KERNEL_TASK_TYPE(151, KERNEL_TYPE_MIX_AIC_1_2);
        GDN::DispatchPhase6ByDtype<Catlass::Gemm::Kernel::GDNFwdHTileShapes128,
                                   GDN::GdnCoreSyncVariant::B15>(
            q, k, v, beta, raw_g, gk, initial_state, cu_seqlens, chunk_indices,
            o, final_state, g_cumsum_bth, A, workspace, tiling);
    } else if (TILING_KEY_IS(161)) {
        KERNEL_TASK_TYPE(161, KERNEL_TYPE_MIX_AIC_1_2);
        GDN::DispatchPhase6ByDtype<Catlass::Gemm::Kernel::GDNFwdHTileShapes128,
                                   GDN::GdnCoreSyncVariant::B16>(
            q, k, v, beta, raw_g, gk, initial_state, cu_seqlens, chunk_indices,
            o, final_state, g_cumsum_bth, A, workspace, tiling);
    } else if (TILING_KEY_IS(171)) {
        KERNEL_TASK_TYPE(171, KERNEL_TYPE_MIX_AIC_1_2);
        GDN::DispatchPhase6ByDtype<Catlass::Gemm::Kernel::GDNFwdHTileShapes128,
                                   GDN::GdnCoreSyncVariant::B17>(
            q, k, v, beta, raw_g, gk, initial_state, cu_seqlens, chunk_indices,
            o, final_state, g_cumsum_bth, A, workspace, tiling);
    } else if (TILING_KEY_IS(181)) {
        KERNEL_TASK_TYPE(181, KERNEL_TYPE_MIX_AIC_1_2);
        GDN::DispatchPhase6ByDtype<Catlass::Gemm::Kernel::GDNFwdHTileShapes128,
                                   GDN::GdnCoreSyncVariant::B18>(
            q, k, v, beta, raw_g, gk, initial_state, cu_seqlens, chunk_indices,
            o, final_state, g_cumsum_bth, A, workspace, tiling);
    } else if (TILING_KEY_IS(191)) {
