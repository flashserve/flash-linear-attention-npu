 ...
 */
#ifndef CHUNK_GATED_DELTA_RULE_FWD_STRUCT_H
#define CHUNK_GATED_DELTA_RULE_FWD_STRUCT_H
...
struct ChunkGatedDeltaRuleCoefficientTiling {
    uint64_t B;
    uint64_t Hk;
    uint64_t Hv;
    uint64_t hvPerHk;
...
struct ChunkGatedDeltaRuleFwdTrailer {
    ChunkGatedDeltaRuleCoefficientTiling coefficient;
...
#endif // CHUNK_GATED_DELTA_RULE_FWD_STRUCT_H
