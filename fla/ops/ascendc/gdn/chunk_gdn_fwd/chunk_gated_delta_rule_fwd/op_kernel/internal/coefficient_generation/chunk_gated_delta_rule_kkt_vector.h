#ifndef CHUNK_GATED_DELTA_RULE_KKT_VECTOR_H
#define CHUNK_GATED_DELTA_RULE_KKT_VECTOR_H

#include "kernel_operator.h"
#include "kernel_utils/vector/regbase.hpp"

namespace NsChunkGatedDeltaRuleKkt {
...
#endif // CHUNK_GATED_DELTA_RULE_KKT_VECTOR_H
