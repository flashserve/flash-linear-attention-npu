...
#undef CATLASS_ARCH
#include "../../chunk_gated_delta_rule_fwd_o/op_kernel/chunk_gated_delta_rule_fwd_o_struct.h"
#include "../../chunk_gated_delta_rule_fwd_o/op_kernel/gemm/kernel/gdn_fwd_o_kernel.hpp"
