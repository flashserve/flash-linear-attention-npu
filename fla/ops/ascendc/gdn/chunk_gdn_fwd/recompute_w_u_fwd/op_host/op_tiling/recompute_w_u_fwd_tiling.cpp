...
/*!
 * \file recompute_w_u_fwd_tiling.cpp
 * \brief
 */
...
ge::graphStatus Tiling4RecomputeWUFwd(gert::TilingContext *context)
{
    ...
    auto kDesc = context->GetDynamicInputDesc(RECOMPUTE_W_U_FWD_INPUT_K_IDX, 0);
    auto betaDesc = context->GetDynamicInputDesc(RECOMPUTE_W_U_FWD_INPUT_BETA_IDX, 0);
    ...
    RecomputeWUFwdTilingContext ctx{
        context->GetNodeName(),
        context->GetRequiredInputShape(RECOMPUTE_W_U_FWD_INPUT_K_IDX),
        context->GetRequiredInputShape(RECOMPUTE_W_U_FWD_INPUT_V_IDX),
        context->GetRequiredInputShape(RECOMPUTE_W_U_FWD_INPUT_BETA_IDX),
        context->GetRequiredInputShape(RECOMPUTE_W_U_FWD_INPUT_A_IDX),
        context->GetRequiredInputShape(RECOMPUTE_W_U_FWD_INPUT_G_IDX),
        context->GetOptionalInputShape(RECOMPUTE_W_U_FWD_INPUT_SEQLENS_IDX),
        context->GetOptionalInputShape(RECOMPUTE_W_U_FWD_INPUT_CHUNK_INDICES_IDX),
        cuSeqlensData,
        chunkIndicesData,
    ...
    if (tiling->V == RECOMPUTE_W_U_FWD_V_DIM_256) {
