...
ASCENDC_TPL_ARGS_DECL(
    ...
    ASCENDC_TPL_BOOL_DECL(OUTPUT_TOKEN_FIRST, 0, 1)
);

#define CHUNK_FWD_O_TPL_SEL_ENTRY(USE_EXP2_VALUE, OUTPUT_TOKEN_FIRST_VALUE) \
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIC_1_2), \
                         ASCENDC_TPL_BOOL_SEL(USE_EXP2, USE_EXP2_VALUE), \
                         ASCENDC_TPL_BOOL_SEL(OUTPUT_TOKEN_FIRST, OUTPUT_TOKEN_FIRST_VALUE))

ASCENDC_TPL_SEL(
    CHUNK_FWD_O_TPL_SEL_ENTRY(0, 0),
    CHUNK_FWD_O_TPL_SEL_ENTRY(0, 1),
    CHUNK_FWD_O_TPL_SEL_ENTRY(1, 1)
);
