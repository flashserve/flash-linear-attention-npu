 ...
 *
 * Host tiling for fused ChunkGatedDeltaRuleFwdPrepare. Field names, types, and order
 * (except the three prepare-only fields) must match ChunkGatedDeltaRuleFwdStageTilingData.
 */

#ifndef CHUNK_GATED_DELTA_RULE_FWD_PREPARE_TILING_H
#define CHUNK_GATED_DELTA_RULE_FWD_PREPARE_TILING_H
